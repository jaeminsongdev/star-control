...
| M6 Cloud Provider | provider conformance, artifact path/ref/file existence, provider request/response fixture, cloud API offline fixture runtime, credential reference, budget/cost, privacy handoff test를 추가한다. |
