...
새 세션은 반드시 `AGENTS.md`, `README.md`, `docs/implementation/README.md`, `docs/implementation/codex-long-run-workflow.md`, `docs/implementation/codex-work-queue-current.md`, 현재 EPIC 문서를 다시 읽는다.
