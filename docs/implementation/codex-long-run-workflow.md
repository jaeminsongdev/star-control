...
- StateStore 작업: `state-store.md`, `artifact-layout.md`, `data-contracts.md`, `run-lifecycle.md`
- Router 작업: `router-engine.md`, `provider-system.md`, `data-contracts.md`
- Validation 작업: `validation-engine.md`, `star-sentinel-full-spec.md`, `policy-profiles.md`
- CLI 작업: `cli-daemon-api-ui.md`, `state-store.md`, `testing-ci-release.md`

## 작업 단위

Codex는 `codex-work-queue.md`의 EPIC 단위를 따른다. EPIC 하나가 너무 크면 TASK 단위로 더 쪼갠다.
...
- package manager lockfile 무단 생성
...
실제 package가 생긴 뒤에는 package별 test command를 추가한다.
...
새 세션은 반드시 `AGENTS.md`, `docs/implementation/README.md`, 현재 EPIC 문서를 다시 읽는다.
