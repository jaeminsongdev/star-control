...
prefixed_id!(StageGraphId, "sgr_");
prefixed_id!(StageResultId, "srs_");
prefixed_id!(RouteDecisionId, "rte_");
prefixed_id!(CapabilitySnapshotId, "cap_");
prefixed_id!(CodexExecutionId, "cdx_");
prefixed_id!(ContextPackId, "ctx_");
prefixed_id!(PermissionPlanId, "ppl_");
